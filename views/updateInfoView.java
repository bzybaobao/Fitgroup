...
import FitGroup.controllers.*;

public class updateInfoView extends FitGroupView {
    ...
    public updateInfoView (Database db) {
        controller = new updateInfoController(db, this);
        prepareGUI();
    }
